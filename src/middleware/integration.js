...
export const claimTokens = async (amount) => {
    if (typeof window.ethereum !== 'undefined') {
      ...
      try {
        ...
        console.log("test4")
        const contract = new ethers.Contract("0xde104384697D1318652042c42bbf34e2206B2fd8", p2eabi, signer);
        console.log("test5")
  ...
  const fetchAllTimeRanking = async () => {
    try {
      ...
      const provider = new ethers.providers.JsonRpcProvider("https://testnet-rpc.meld.com");
      const contract = new ethers.Contract("0xde104384697D1318652042c42bbf34e2206B2fd8", p2eabi, provider);
  ...
  const fetchLast7DaysRanking = async () => {
    try {
      const provider = new ethers.providers.JsonRpcProvider("https://testnet-rpc.meld.com");
      const contract = new ethers.Contract("0xde104384697D1318652042c42bbf34e2206B2fd8", p2eabi, provider);
